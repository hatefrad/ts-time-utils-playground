# ts-time-utils Playground

Interactive playground and documentation for [ts-time-utils](https://github.com/hatefrad/ts-time-utils).

## Features

- Editable examples with in-browser execution
- 32 interactive categories documented
- Run and modify examples in browser
- Examples run against `ts-time-utils@4.4.1`
...
| Range Presets | Common date range presets |
...
Deployed via Cloudflare Pages at [ts-time-utils.h8frad.work](https://ts-time-utils.h8frad.work)
